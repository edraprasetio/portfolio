...
import figma from '../assets/icons/skills/figma-icon.svg'
...
export function Skills() {
    const items = [
        ...
        { id: 7, name: 'Figma', category: 'Development Tools', yearsOfExperience: 3, imageUrl: figma },
        { id: 8, name: 'Git', category: 'Development Tools', yearsOfExperience: 5, imageUrl: git },
        { id: 9, name: 'Go', category: 'Programming Languages', yearsOfExperience: 3, imageUrl: go },
        { id: 10, name: 'HTML', category: 'Development Tools', yearsOfExperience: 2, imageUrl: html },
        { id: 11, name: 'Java', category: 'Programming Languages', yearsOfExperience: 5, imageUrl: java },
        { id: 12, name: 'JavaScript', category: 'Programming Languages', yearsOfExperience: 2, imageUrl: javaScript },
        { id: 13, name: 'MongoDB', category: 'Databases', yearsOfExperience: 1, imageUrl: mongodb },
        { id: 14, name: 'MySQL', category: 'Databases', yearsOfExperience: 3, imageUrl: mysql },
        { id: 15, name: 'Node.js', category: 'Development Tools', yearsOfExperience: 2, imageUrl: nodeJS },
        { id: 16, name: 'PostgreSQL', category: 'Databases', yearsOfExperience: 3, imageUrl: postgress },
        { id: 17, name: 'Python', category: 'Programming Languages', yearsOfExperience: 5, imageUrl: python },
        { id: 18, name: 'R', category: 'Programming Languages', yearsOfExperience: 2, imageUrl: r },
        { id: 19, name: 'React', category: 'Development Tools', yearsOfExperience: 2, imageUrl: react },
        { id: 20, name: 'TypeScript', category: 'Programming Languages', yearsOfExperience: 2, imageUrl: typeScript },
        { id: 21, name: 'WordPress', category: 'Development Tools', yearsOfExperience: 0.5, imageUrl: wordPress },
    ]
